...
Generate crud API for the html form.
...
```
cd existing_repo
git remote add origin https://gitlab.diamnow.com/kesar.bhimani/crud-gen.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.diamnow.com/kesar.bhimani/crud-gen/-/settings/integrations)
